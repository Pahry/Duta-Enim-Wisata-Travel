		...
		<div class="col-md-10 p-5 pt-2">
			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">	
					<input class="form-control" type="text" name="nama_loket" id="nama_loket" required>	
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">	
					<input class="form-control" type="text" name="pengurus_loket" id="pengurus_loket" required>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">	
					<input class="form-control" type="text" name="nohp_loket" id="nohp_loket" required>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">			
					<textarea class="form-control" type="text" name="alamat_loket" id="alamat_loket" required></textarea>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">			
					<input class="form-control" type="file" name="foto_loket" required>
					</div>
				</div>

				<div class="col-sm-10 offset-sm-2">
					<button class="btn btn-primary" type="submit" name="kirim"><i class="fa fa-plus"></i> Tambah Loket</button>
