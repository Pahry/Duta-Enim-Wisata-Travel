			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				<div class="form-group row">
					...
					<div class="col-md-4 col-sm-10">
						<input class="form-control" type="text" name="nama_supir" id="nama_supir" required>
					</div>

					<label class="col-md-2 col-form-label" for="ttl_supir">Tempat Tanggal Lahir</label>
					<div class="col-md-4 col-sm-10">
						<input class="form-control" type="date" name="ttl_supir" id="ttl_supir" required>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-md-4 col-sm-10">
						<input class="form-control" type="text" name="tipe_mobil" id="tipe_mobil" required>
					</div>

					<label class="col-md-2 col-form-label" for="plat_mobil">Plat Mobil</label>
					<div class="col-md-4 col-sm-10">
						<input class="form-control" type="text" name="plat_mobil" id="plat_mobil" required>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-md-4 col-sm-10">
						<div class="form-check">
							<input class="form-check-input" type="checkbox" name="sim[]" id="sim" value="SIM A">SIM A</input>
						</div>
						<div class="form-check">
							<input class="form-check-input" type="checkbox" name="sim[]" id="sim" value="SIM B I">SIM B I</input>
						</div>
						<div class="form-check">
							<input class="form-check-input" type="checkbox" name="sim[]" id="sim" value="SIM B II">SIM B II</input>
						</div>
						<div class="form-check">
							<input class="form-check-input" type="checkbox" name="sim[]" id="sim" value="SIM C">SIM C</input>
						</div>
						<div class="form-check">
							<input class="form-check-input" type="checkbox" name="sim[]" id="sim" value="SIM D">SIM D</input>
						</div>
					</div>

					<label class="col-md-2 col-form-label" for="nohp_supir">Nomor HP Supir</label>
					<div class="col-md-4 col-sm-10">
						<input class="form-control" type="tel" name="nohp_supir" id="nohp_supir" required>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-md-4 col-sm-10">
						<input class="form-control" name="alamat_supir" id="alamat_supir" required></input>
					</div>

					<label class="col-md-2 col-form-label" for="foto_supir">Foto</label>
					<div class="col-md-4 col-sm-10">
						<input class="form-control" type="file" name="foto_supir" required>
					</div>
				</div>

				<div class="col-md-10 col-sm-12 offset-md-2">	
					<button class="btn btn-primary" type="submit" name="kirim"><i class="fa fa-plus"></i> Tambah Supir</button>
